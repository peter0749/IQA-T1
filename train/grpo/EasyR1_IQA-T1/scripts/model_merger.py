...
if __name__ == "__main__":
    ...
    parser.add_argument("--local_dir", required=True, type=str, help="The path for your saved model (checkpoint root or .../actor)")
    ...
    # If not found in local_dir, try local_dir/actor (checkpoint root vs actor subdir)
    if not world_size and os.path.isdir(os.path.join(local_dir, "actor")):
        actor_dir = os.path.join(local_dir, "actor")
    ...
    # #region agent log (disabled for open-source release)
    # try:
    #     import json as _json
    #     _log = {"hypothesisId": "H1", "location": "model_merger:main", "message": "local_dir and world_size", "data": {"local_dir": local_dir, "world_size": world_size, "arg_local_dir": args.local_dir}, "timestamp": __import__("time").time()}
