...
class DataConfig:
    train_files: str = ""
    val_files: Optional[str] = None  # None or empty = no validation set
    ...
    """Jinja template file path. When set, user message = render(template, content=prompt_key). Ignored if system_prompt is set."""
    system_prompt: Optional[str] = None
    """System prompt file path (plain text). When set, messages = [system, user] with user = prompt_key only; format_prompt is ignored."""
