...
Released IQA-T1 on official KonIQ test (n=2015): PLCC 0.942 / SRCC 0.927 vs Table 1 0.942 / 0.925. See [KONIQ_TEST_PLCC.md](KONIQ_TEST_PLCC.md). Not the seven-dataset average.
...
2. E1 protocol v1 has been executed. L3–L5 remain exploratory pilots. H is inconclusive; do not train or enlarge the sample without a new Outcome.
